...
export function CertificationBanner({ bannerUrl, title, adsCount, handleClick }:CertificationBannerProps) {
    return(
        <div className="relative rounded-lg overflow-hidden" onClick={handleClick} title={title}>
          <img src={bannerUrl} />
          
          <div className="w-full px-2 py-2 pt-16 md:pb-4 md:px-4 bg-certificiation-gradient absolute bottom-0 left-0 right-0">
